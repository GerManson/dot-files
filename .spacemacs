...
values."
  (setq-default
   ...
   ;; List of additional paths where to look for configuration autilayers.
   ;; Paths must have a trailing slash (i.e. `~/.mycontribs/' return;)
